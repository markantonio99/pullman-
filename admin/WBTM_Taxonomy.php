		...
		class WBTM_Taxonomy {
			...
			public function taxonomy() {
                ...
                $labels_drop_off = array(
                    'name' => $name . ' ' . esc_html__('Ritorno', 'bus-ticket-booking-with-seat-reservation'),
                    'singular_name' => esc_html__($name . ' Ritorno', 'bus-ticket-booking-with-seat-reservation'),
                    'menu_name' => esc_html__($name . ' Ritorno', 'bus-ticket-booking-with-seat-reservation'),
                    'all_items' => esc_html__('Allx ' . $name . ' Bus Ritorno', 'bus-ticket-booking-with-seat-reservation'),
                    'parent_item' => esc_html__('Parent', 'bus-ticket-booking-with-seat-reservation') . ' ' . $name . ' ' . esc_html__('Ritorno', 'bus-ticket-booking-with-seat-reservation'),
                    'parent_item_colon' => _x('Parent ' . $name . ' Ritorno:', 'bus-ticket-booking-with-seat-reservation'),
                    'new_item_name' => _x('New ' . $name . ' Ritorno Name', 'bus-ticket-booking-with-seat-reservation'),
                    'add_new_item' => esc_html__('Add New', 'bus-ticket-booking-with-seat-reservation') . ' ' . $name . ' ' . esc_html__('Ritorno', 'bus-ticket-booking-with-seat-reservation'),
                    'edit_item' => _x('Edit ' . $name . ' Ritorno', 'bus-ticket-booking-with-seat-reservation'),
                    'update_item' => _x('Update ' . $name . ' Ritorno', 'bus-ticket-booking-with-seat-reservation'),
                    'view_item' => _x('View ' . $name . ' Ritorno', 'bus-ticket-booking-with-seat-reservation'),
                    'separate_items_with_commas' => _x('Separate Category with commas', 'bus-ticket-booking-with-seat-reservation'),
                    'add_or_remove_items' => _x('Add or remove ' . $name . ' Pickup Point', 'bus-ticket-booking-with-seat-reservation'),
                    'choose_from_most_used' => _x('Choose from the most used', 'bus-ticket-booking-with-seat-reservation'),
                    'popular_items' => _x('Popular' . $name . ' Ritorno', 'bus-ticket-booking-with-seat-reservation'),
                    'search_items' => _x('Search' . $name . ' Ritorno', 'bus-ticket-booking-with-seat-reservation'),
                    'not_found' => _x('Not Found', 'bus-ticket-booking-with-seat-reservation'),
                    'no_terms' => _x('No' . $name . ' Ritorno', 'bus-ticket-booking-with-seat-reservation'),
                    'items_list' => _x($name . ' Ritorno list', 'bus-ticket-booking-with-seat-reservation'),
                    'items_list_navigation' => _x($name . ' Ritorno list navigation', 'bus-ticket-booking-with-seat-reservation'),
                );
                $args_drop_off = array(
                    'hierarchical' => true,
                    "public" => true,
