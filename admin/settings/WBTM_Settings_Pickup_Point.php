    ...
    class WBTM_Settings_Pickup_Point {
        ...
        public function tab_content($post_id) {
            ...
            <div class="tabsItem" data-tabs="#wbtm_settings_pickup_point">
                <h3><?php esc_html_e('Pickup And Ritorno Settings', 'bus-ticket-booking-with-seat-reservation'); ?></h3>
            ...
            <div class="">
                ...
                <div class="_dLayout_dFlex_justifyBetween ">
                    <div class="col_8 _dFlex_fdColumn">
                        <label>
                            <?php esc_html_e('Ritorno Settings', 'bus-ticket-booking-with-seat-reservation'); ?> 
                        </label>
                        <span>
                ...
                <div data-collapse="#show_drop_off_point" class="_dLayout <?php echo esc_attr($active_drop_off_point); ?>">
                    <?php if (sizeof($dp_points) > 0) { ?>
                        ...
                        <?php } else { ?>
                            <?php WBTM_Layout::msg(esc_html__('You have no Ritorno. Please add Ritorno from left sidebar menu.', 'bus-ticket-booking-with-seat-reservation')); ?>
                        <?php } ?>
                    <?php } else { ?>
                        <?php WBTM_Layout::msg(esc_html__('You have no Bus route. Please add Price and Route and save ,then you can edit Ritorno.', 'bus-ticket-booking-with-seat-reservation')); ?>
                    <?php } ?>
                </div>
			</div>
			<?php
				...
				<tr class="mp_remove_area">
					...
					<td colspan="3">
						<div class="mp_settings_area">
							...
							<?php MP_Custom_Layout::add_new_button(esc_html__('Add Ritorno', 'bus-ticket-booking-with-seat-reservation')); ?>
							<div class="mp_hidden_content">
								<table>
									<tbody class="mp_hidden_item">
