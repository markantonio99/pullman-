...
?>
                ...
                <div class="mpTabs leftTabs">
                    <ul class="tabLists">
                        ...
                        <li data-tabs-target="#wbtm_settings_pickup_point">
                            <span class="fas fa-route"></span><?php esc_html_e('Seleziona Ritorno', 'bus-ticket-booking-with-seat-reservation'); ?>
                        </li>
        ...
        public static function description_array($key) {
            $des = array(
                ...
                'show_drop_off_point' => esc_html__('Turn On or Off Ritorno.', 'bus-ticket-booking-with-seat-reservation'),
