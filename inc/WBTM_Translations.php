...
*/
	...
	if (!class_exists('WBTM_Translations')) {
		class WBTM_Translations {
			...
			public static function text_drop_off_point() { return esc_html__('Ritorno', 'bus-ticket-booking-with-seat-reservation'); }
			...
			public static function text_available() { return esc_html__('Posti disponibili', 'bus-ticket-booking-with-seat-reservation'); }
